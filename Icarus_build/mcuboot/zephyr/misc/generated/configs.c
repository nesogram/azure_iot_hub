...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ACTINIUS_BOARD_CONTROL_LOG_LEVEL, 0);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SRAM_SIZE, 88);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_ACTINIUS_ICARUS_NRF9160, 1);
